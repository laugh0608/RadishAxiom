...
- [Checker Runtime Payload Registration v0.1](checker-runtime-payloads-v0.1/README.md)：绑定 checker source、target、artifact / provenance / acceptance、候选 / durable provider、字节 retention / fetch 与登记状态机；当前 source 的 distribution package 已完成临时候选直传与独立回读，GitHub immutable Release provider 已选但设置尚未验证且 Release 未物化，active runtime 为 0。
