...
- [Checker Runtime Payload Registration v0.1](checker-runtime-payloads-v0.1/README.md)：绑定 checker source、target、artifact / provenance / acceptance、候选 / durable provider、字节 retention / fetch、登记状态机与 launcher policy；当前精确 distribution 已不可变发布并登记为 `registered-inactive`，launcher / installation / qualification 尚未实现，active runtime 为 0。
